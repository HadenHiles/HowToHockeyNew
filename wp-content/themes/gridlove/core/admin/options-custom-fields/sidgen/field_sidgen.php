...
if ( ! class_exists( 'ReduxFramework_sidgen' ) ) {
    ...
    class ReduxFramework_sidgen {
        ...
        public function render() {
            ...
            $this->add_text   = ( isset( $this->field['add_text'] ) ) ? $this->field['add_text'] : esc_html__( 'Add Sidebar', 'gridlove' );
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                get_parent_theme_file_uri( '/core/admin/options-custom-fields/sidgen/field_sidgen.js' ),
