(function($) {
    ...
    $(document).ready(function() {
        ...
        function gridlove_template_metaboxes(scroll, t) {

            var template = t ? t : $(gridlove_template_selector).val();
