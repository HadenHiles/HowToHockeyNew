<div id="welcome-panel" class="welcome-panel gridlove-welcome-panel">
	...
	<div class="welcome-panel-content">
		...
		<p class="about-description">Gridlove has been successfully updated to version <?php echo GRIDLOVE_THEME_VERSION; ?></a></p>

		<div class="welcome-panel-column-container">

				<?php if( version_compare( GRIDLOVE_THEME_VERSION, '1.9', '>=' ) && version_compare( get_option( 'gridlove_theme_version', '0.0.0' ), '1.8', '<=' ) ) : ?>
					...
					<a href="http://mekshq.com/docs/gridlove-change-log" target="_blank" class="button button-primary button-hero">Read more</a>
					</div>
