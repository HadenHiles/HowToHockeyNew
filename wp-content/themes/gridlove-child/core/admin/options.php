...
$args = array(
    'opt_name'             => $opt_name,
    'display_name'         => wp_kses( sprintf( __( 'Gridlove Options%sTheme Documentation%s', 'gridlove' ), '<a href="http://mekshq.com/documentation/gridlove" target="_blank">', '</a>' ), wp_kses_allowed_html( 'post' )),
    'display_version'      => gridlove_get_update_notification(),
    'menu_type'            => 'menu',
    'allow_sub_menu'       => true,
    'menu_title'           => esc_html__( 'Theme Options', 'gridlove' ),
    'page_title'           => esc_html__( 'Gridlove Options', 'gridlove' ),
    'google_api_key'       => '',
...
if ( !function_exists( 'gridlove_redux_custom_css' ) ):
    function gridlove_redux_custom_css() {
        wp_register_style( 'gridlove-redux-custom', get_parent_theme_file_uri('/assets/css/admin/options.css'), array( 'redux-admin-css' ), GRIDLOVE_THEME_VERSION );
...
add_action( 'init', 'gridlove_redux_cleanup' );

if ( !function_exists( 'gridlove_redux_cleanup' ) ):
	function gridlove_redux_cleanup() {
...
if ( !function_exists( 'gridlove_rwdo_field_path' ) ):
	function gridlove_rwdo_field_path( $field ) {
		return get_parent_theme_file_path( '/core/admin/options-custom-fields/rwdo/field_rwdo.php' );
	}
endif;

add_filter( "redux/gridlove_settings/field/class/rwdo", "gridlove_rwdo_field_path" );
...
if ( !function_exists( 'gridlove_section_field_path' ) ):
	function gridlove_section_field_path( $field ) {
		return get_parent_theme_file_path( '/core/admin/options-custom-fields/section/section.php' );
	}
endif;

add_filter( "redux/gridlove_settings/field/class/gridlove_section", "gridlove_section_field_path" );
