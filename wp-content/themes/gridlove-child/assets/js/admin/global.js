(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.gridlove-redux-marker').each(function() {
            var elem = $(this);
        ...
        $("body").on('click', '#gridlove_welcome_box_hide', function(e) {
            ...
            $.post(ajaxurl, { action: 'gridlove_hide_welcome' }, function(response) {});
        });

        $("body").on('click', '#gridlove_update_box_hide', function(e) {
            e.preventDefault();
            $(this).parent().remove();
            $.post(ajaxurl, { action: 'gridlove_update_version' }, function(response) {});
        });
